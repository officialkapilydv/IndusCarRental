    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-white text-slate-800">
      ...
      <section className="relative bg-gradient-to-r from-sky-600 to-sky-800 text-white">
        <div className="mx-auto max-w-7xl px-4 py-16">
          ...
          <motion.p 
            ...
            className="text-center mt-4 text-lg text-sky-100 max-w-3xl mx-auto"
          >
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-2">
                        <a href="tel:9717618797" className="block text-sky-600 hover:text-sky-800 font-medium">
                          9717618797
                        </a>
                        <a href="tel:9355361005" className="block text-sky-600 hover:text-sky-800 font-medium">
                          9355361005
                        </a>
                        <a href="tel:01244200022" className="block text-sky-600 hover:text-sky-800 font-medium">
                          0124-4200022
                        </a>
                      </div>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <a href="mailto:induscarrental@gmail.com" className="text-sky-600 hover:text-sky-800 font-medium break-all">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full rounded-lg border border-slate-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-sky-600"
                  ...
                  <button
                    type="submit"
                    className="w-full bg-sky-600 hover:bg-sky-700 text-white font-semibold py-3 rounded-lg transition flex items-center justify-center gap-2"
                  >
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <h2 className="text-2xl font-bold text-sky-700 mb-6 text-center">Find Us Here</h2>
          <Card>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="mt-16 text-center bg-gradient-to-r from-sky-600 to-sky-800 text-white rounded-2xl p-12"
        >
          ...
          <button 
            onClick={() => navigate("/")}
            className="bg-white text-sky-700 px-8 py-3 rounded-lg font-semibold hover:bg-sky-50 transition"
          >
            BOOK NOW
          </button>
        </motion.div>
